...
int main() {
	...
	for (int i = -5; i < 0; i++) { // Wype�nienie listy pocz�tkowymi warto�ciami
		list.addFront(i);
	}

	for (int i = 0; i < iteracje; i++) { // Dodawanie element�w na pocz�tek listy
	...
	for (int i = 0; i < iteracje; i++) { // Dodawanie element�w na koniec listy
		auto start = chrono::high_resolution_clock::now();
		list.addBack(i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < iteracje; i++) { // Wype�nienie listy pocz�tkowymi warto�ciami
		list.addFront(i);
	}

	for (int i = 0; i < iteracje; i++) { // Dodawanie element�w na zadany indeks listy
		auto start = chrono::high_resolution_clock::now();
		list.addAt(i, -i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < iteracje; i++) { // Usuwanie element�w z pocz�tku listy
		auto start = chrono::high_resolution_clock::now();
		list.removeFront();
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < iteracje; i++) { // Usuwanie element�w z ko�ca listy
		auto start = chrono::high_resolution_clock::now();
		list.removeBack();
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = iteracje; i > 0; i--) { // Usuwanie element�w z zadanym indeksem listy
		auto start = chrono::high_resolution_clock::now();
		list.removeAt(i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < iteracje; i++) { // Szukanie element�w po indeksie listy
		auto start = chrono::high_resolution_clock::now();
		list.findByIndex(i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < iteracje; i++) { // Szukanie element�w po warto�ci w li�cie
		auto start = chrono::high_resolution_clock::now();
		list.findByValue(i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = -5; i < 0; i++) { // Wype�nienie tablicy pocz�tkowymi warto�ciami
		arr.insertOnFront(i);
	}

	for (int i = 0; i < iteracje; i++) { // Dodawanie element�w na pocz�tek tablicy
		auto start = chrono::high_resolution_clock::now();
		arr.insertOnFront(i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < 0; i++) { // Wype�nienie tablicy pocz�tkowymi warto�ciami
		arr.insertOnFront(i);
	}

	for (int i = 0; i < iteracje; i++) { // Dodawanie element�w na koniec tablicy
		auto start = chrono::high_resolution_clock::now();
		arr.insertOnBack(i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < iteracje; i++) { // Wype�nienie tablicy pocz�tkowymi warto�ciami
		arr.insertOnFront(i);
	}

	for (int i = 0; i < iteracje; i++) { // Dodawanie element�w na zadany indeks tablicy
		auto start = chrono::high_resolution_clock::now();
		arr.insertAt(i, -i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < iteracje; i++) { // Usuwanie element�w z pocz�tku tablicy
		auto start = chrono::high_resolution_clock::now();
		arr.removeFront();
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < iteracje; i++) { // Usuwanie element�w z ko�ca tablicy
		auto start = chrono::high_resolution_clock::now();
		arr.removeBack();
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = iteracje; i > 0; i--) { // Usuwanie element�w z zadanym indeksem tablicy
		auto start = chrono::high_resolution_clock::now();
		arr.removeAt(i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < iteracje; i++) { // Szukanie element�w po indeksie w tablicy
		auto start = chrono::high_resolution_clock::now();
		arr.findByIndex(i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
	...
	for (int i = 0; i < iteracje; i++) { // Szukanie element�w po warto�ci w tablicy
		auto start = chrono::high_resolution_clock::now();
		arr.findByValue(i);
		auto stop = chrono::high_resolution_clock::now();
		auto duration = chrono::duration_cast<chrono::nanoseconds>(stop - start);
